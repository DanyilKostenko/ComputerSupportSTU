...
v1 <- 18.12312321
v2 <- 29L
v3 <- "charakter variable Danyil Kostenko"
v4 <- TRUE 
v5 <- 16+8i
...
```{r}
# code for solving task
age_factor <- factor(c("infant", "child", "abult"), levels = c("infant", "child", "adult"))
print(age_factor)
```
...
```{r}
names(my_data) <- c("Meno", "Vek", "Pohlavie", "Vyška")
my_data
```